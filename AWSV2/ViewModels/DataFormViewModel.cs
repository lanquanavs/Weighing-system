...
namespace AWSV2.ViewModels
{
    public class DataFormViewModel : IHandle<MainShellViewEvent>
    {
        ...
        public List<WeighingRecord> WList { get; private set; } //从数据库中查询出的原始称重记录列表
        ...
        public void GetData(string beginDate, string endDate, string dateRange)
        {
            ...
            zh = zh == null ? new Common.Models.WeighingRecord() : zh;
            zh1 = zh1 == null ? new Common.Models.WeighingRecord() : zh1;
            xs = xs == null ? new Common.Models.WeighingRecord() : xs;
            xs1 = xs1 == null ? new Common.Models.WeighingRecord() : xs1;
            cg = cg == null ? new Common.Models.WeighingRecord() : cg;
            cg1 = cg1 == null ? new Common.Models.WeighingRecord() : cg1;
