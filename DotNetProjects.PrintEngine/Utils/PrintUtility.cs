    ...
    public class PrintUtility
    {
        ...
        public Thickness GetPageMargin(string currentPrinterName)
        {
            ...
            if (!_cacheHelper.Contains(key))
            {
                ...
                _cacheHelper.Add(key, new Thickness(hardMarginX + 20, hardMarginY + 5, printerSettings.DefaultPageSettings.Margins.Right, printerSettings.DefaultPageSettings.Margins.Bottom + 50));
            }
