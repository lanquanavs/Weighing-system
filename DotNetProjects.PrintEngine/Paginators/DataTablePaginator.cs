...
namespace SUT.PrintEngine.Paginators
{
    public class DataTablePaginator : ItemsPaginator
    {
        ...
        {            
            ...
            {
                lastTotalWidth = totalWidth + PrintTableDefination.ColumnWidths[i] * PrintTableDefination.Scale;
                if (totalWidth + PrintTableDefination.ColumnWidths[i] * PrintTableDefination.Scale <= PrintablePageWidth)
                {
                    totalWidth += PrintTableDefination.ColumnWidths[i] * PrintTableDefination.Scale;
                    columnCount++;
                }
                else
                {
